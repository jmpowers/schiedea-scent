...
load("data/markes_sequence230908_2023.rda") #2023 only
...
# save(sequ.summary, file="data/sequ_summary221006.rda")
load("data/sequ_summary221006.rda") #2022 and earlier
...
write.csv(schgc, "data/schiedea_all230908.csv")
...
schgc.verdict2122 <- schgc[c(106:142,910:991),] %>% #842:891
