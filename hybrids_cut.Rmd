...
grid.text(rev(levels(svhyb$SpeciesR))[c(1,4)], x=c(0.185,0.5),y=0.964, gp=gpar(fontsize=10, col="white", fontface=4))
grid.text(rev(levels(svhyb$SpeciesR))[c(2,3)], x=c(0.323,0.405),y=0.964, gp=gpar(fontsize=10, col="white", fontface=2))
```
